...
declare module 'vue' {
	interface ComponentCustomProperties {
		...
		>
		readonly ROUTER_NAME_HOME_PAGE: UnwrapRef<
			typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['ROUTER_NAME_HOME_PAGE']
		>
		readonly ROUTER_PATH_HOME_PAGE: UnwrapRef<
			typeof import('@/config/env/ENV_AUTO_IMPORT.mjs')['ROUTER_PATH_HOME_PAGE']
		>
